<cfif structKeyExists(URL, "fileToGrab")>
	<cfswitch expression="#Trim(URL.fileToGrab)#">
		<cfcase value="pySubscribe">
			...
			<cfset pathToFile = "/devObjective2016/python/sns/subscribeViaEmail.py" />
		</cfcase>
		<cfcase value="pySendSNS">
			<cfset fileTitle = "Python: Send a Test SNS Notification" />
			<cfset pathToFile = "/devObjective2016/python/sns/publishToSNS.py" />
		</cfcase>
		<cfcase value="pyCheckServers">
			<cfset fileTitle = "Python: Check Servers" />
			<cfset pathToFile = "/devObjective2016/python/lambda/checkServers.py" />
		</cfcase>
		<cfcase value="jsLargeFile">
			<cfset fileTitle = "Node: Check for Large File Uploads" />
			<cfset pathToFile = "/devObjective2016/nodejs/lambda/checkForLargeFileUploads.js" />
		</cfcase>
		<cfcase value="jsReturnData">
			<cfset fileTitle = "Node: Return Data to Caller" />
			<cfset pathToFile = "/devObjective2016/nodejs/lambda/returnDataToCaller.js" />
		</cfcase>
		<cfdefaultcase>
...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>dev.Objective() 2016: AWS Service Demos</title>
